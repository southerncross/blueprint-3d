...
// Blueprint
export const replaceBlueprints = makeAction('REPLACE_BLUEPRINTS')
export const syncBlueprints = makeAction('SYNC_BLUEPRINTS')
export const deleteBlueprints = makeAction('DELETE_BLUEPRINTS')
